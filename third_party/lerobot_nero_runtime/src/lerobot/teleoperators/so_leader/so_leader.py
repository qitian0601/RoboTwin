...
from .config_so_leader import SOLeaderTeleopConfig, SO1018DofLeaderConfig
...
class SOLeader(Teleoperator):
    ...
    def __init__(self, config: SOLeaderTeleopConfig):
        ...
        if isinstance(config, SO1018DofLeaderConfig):
            motors = {
    ...
    def calibrate(self) -> None:
        ...
        if full_turn_motor in self.bus.motors:
...
SO1018DofLeader: TypeAlias = SOLeader
